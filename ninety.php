<html>
			...
			color: black;tom: 4px;">
					<td colspan = 2>
					<b><font style="font-size:1.2em;color:green;">Geometry >> Angel >> Perpendicular Angle :</font></b><br>
					<p>
					<b>Objective: </b>Drawing perpendicular Angle with PHP.
					</p>
					<p>
...
//makes right angel
	...
	//delete one side of an triangle 
	imageline($image,100,50,300,300,$blackAlpha);
	//makes an angle
...
//call image
	imagepng($image,"image/ninety.png");
	imagedestroy($image);
	
	echo '<center><img src="image/ninety.png"></center>';
?>
					</td>
					<td width = 10%>
...
<spamg>//makes right angel</spamg>
	...
	imagepolygon($image,$point,3,$green);
	<spamg>//delete one side of an triangle</spamg> 
	imageline($image,100,50,300,300,$blackAlpha);
	<spamg>//makes an angle</spamg>
	imagearc($image, 100, 300, 40, 40,  270, 360, $white);
	<spamg>//set imagestring</spamg>
	imagestring($image,10,120,270,'90',$white);
