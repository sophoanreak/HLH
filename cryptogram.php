<html>	
		<table width = 660px border = 0 cellpadding = 5 cellspacing = 0 bgcolor = "#f1f1f1" style = "border-collapse: collapse;">
			...
			<tr>
				<td>
				<font style = "font-size:1.2em; font-weight:bold;">Math Games : Crytogram</font>
				</td>
			</tr>
			<tr style="background-color:#A7C942">
				<td>
				<font style = "font-size:1.2em;" color = "white" >
					<a href="index.php?homepage=cryptogram&subhomepage=encryptedtext">Encrypted Text</a> | 
		...
		<?php	
			if (isset($_REQUEST['subhomepage'])){
					...
					switch ($subhomepage){
						...
						case "encryptedtext":
							include "encryptedtext.php";
							break;

						default:
							include "encryptedtext.php";
					}
			}else {include "encryptedtext.php";}
