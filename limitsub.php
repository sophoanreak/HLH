<html>
			...
			color: black;tom: 4px;">
					...
					<p>
					<b>Objective: </b>The uses of  Limits on PHP. <br>Below is limit of X => 1 and M of tangent line => 2. From the equation of Y = X * X. <br> The equation of a tangent line is Y = 2X - 1.
...
//scale up 30 times
	...
	imagestring($image,2,$x1+40,$y1-60,'Limit of M(Tan) = 2',$green);
	imagestring($image,2,$x1+40,$y1-50,'Limit of X => 1',$green);
...
//call image
	imagepng($image,"image/limitsub.png");
	imagedestroy($image);
	
	echo '<center><img src="image/limitsub.png"></center>';
