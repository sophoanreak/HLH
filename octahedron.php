<html>
		...
		<script>
		var camera, octahedron, scene, renderer , container, plane;
		...
		function init(){
			...
			//create Convas
			var geometry2 = new THREE.OctahedronGeometry( 90, 0 );
			...
			//plane.position.set(0,0,0);
				//octahedron
			octahedron = new THREE.Mesh( geometry2, material);
				//add wireframe helper
			wireframe = new THREE.WireframeHelper( octahedron, 0xf000000 );
			octahedron.position.set(0,0,90);
			...
			color: black;tom: 4px;">
					<td colspan = 2>
					<b><font style="font-size:1.2em;color:green;">Geometry >> Polyhedron >> Octahedron :</font></b><br>
					<p>
					<b>Objective: </b>Drawing Octahedron on JavaScript. Octahedron: polyhedron with 8 faces, 12 edges, 6 vertices and each face is an equilateral triangle.
					</p>
					<p>
...
?>
	<b><u>Octahedron with JavaScript</u></b><br><br>			
