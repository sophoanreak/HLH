<html>
			...
			color: black;tom: 4px;">
					...
					<p>
					<b>Objective:</b> How to find Prime Number using AKS Test with PHP.<br>
						Coefficients are divisible by p. P is a test number for a prime number.<br> Testing equation: (x-1)<sup>p</sup> - (x<sup>p</sup>-1).
					</p>

<?php

echo "<h3>Prime Number- AKS Test</h3>";
