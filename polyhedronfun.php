<html>
		...
		<script>
		var camera, icosahedron, dodecahedron, scene, renderer , container, plane;
		...
		function init(){
			...
			//create Convas
			var geometry1 = new THREE.DodecahedronGeometry( 70, 0 );
			var geometry2 = new THREE.IcosahedronGeometry( 90, 0 );
			
			//Material
			var skeleton = new THREE.MeshBasicMaterial({
				color:0x551a8b,
				wireframe:'true',
			...
			//plane.position.set(0,0,0);
				//dodecahedron
			dodecahedron = new THREE.Mesh( geometry1, material);
			icosahedron = new THREE.Mesh ( geometry2, skeleton );
				//add wireframe helper
			wireframe = new THREE.WireframeHelper( dodecahedron, 0xf1f1f1 );
			dodecahedron.position.set(0,0,90);
			...
			color: black;tom: 4px;">
					<td colspan = 2>
					<b><font style="font-size:1.2em;color:green;">Geometry >> Polyhedron >> Fun :</font></b><br>
					<p>
					<b>Objective: </b>Drawing Dodecahedron in Icosahedron on JavaScript. 
					</p>
					<p>
...
?>
	<b><u>Dodecahedron in Icosahedron with JavaScript</u></b><br><br>			
...
<spamr>//For 3D box to work it is require three.min.js </spamr><a href = "http://www.html5canvastutorials.com/libraries/three.min.js" style = "color:blue">" Three.min.js"</a>
	...
	<spamb>&lt;script></spamb>
	var camera, dodecahedron, scene, renderer , container, plane;
		...
		function init(){
			...
			<spamg>//plane.position.set(0,0,0);</spamg>
				<spamg>//dodecahedron</spamg>
			dodecahedron = new THREE.Mesh( geometry2, material);
				<spamg>//add wireframe helper</spamg>
			wireframe = new THREE.WireframeHelper( dodecahedron, 0xf000000 );
			dodecahedron.position.set(0,0,90);
