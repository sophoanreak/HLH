<html>
		...
		function init(){
			...
			//create Convas
			var geometry2 = new THREE.DodecahedronGeometry( 90, 0 );
			...
			color: black;tom: 4px;">
					<td colspan = 2>
					<b><font style="font-size:1.2em;color:green;">Geometry >> Polyhedron >> Dodecahedron :</font></b><br>
					<p>
					<b>Objective: </b>Drawing Dodecahedron on JavaScript. Dodecahedron: Polyhedron with 12 faces, each face has 5 edges (a pentagon), 30 edges, and 20 vertices.
					</p>
					<p>
